...
# roll the dice and display the result (modified)
echo "Rolling two six sided dice.
You rolled..... $(( RANDOM % 6 + 1)), $(( RANDOM % 6 + 1 ))
"

# rolling 5 six sided dice
echo "Rolling five six sided dice.  Thats alot!
You rolled..... $(( RANDOM % 6 + 1)), $(( RANDOM % 6 + 1 )), $(( RANDOM % 6 + 1 )), $(( RANDOM % 6 + 1 )), $(( RANDOM % 6 + 1 ))
"

# rolling 1 D20
echo "Now rolling a D20.... Wait are we playing D&D?
